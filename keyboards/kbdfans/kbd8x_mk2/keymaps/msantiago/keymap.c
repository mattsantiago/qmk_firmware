...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT( 
	...
	KC_ENT,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  TG(2),   _______,          _______, _______, KC_VOLU, \
	KC_LEAD, KC_INS,  KC_HOME, KC_PGUP, KC_LOCK, KC_WFWD, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, _______,          _______,          _______, KC_MUTE, KC_VOLD, \
	_______, KC_DEL,  KC_END,  KC_PGDN, KC_F5,   KC_WBAK, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,                   _______,                                     \
	_______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_BTN1, KC_BTN3, KC_BTN2, _______, _______, _______,          _______, _______,                   KC_MPLY,          \
	_______, _______, _______,                            KC_ESC,                                      _______, TG(3),   KC_APP,  _______,          KC_MPRV, KC_MSTP, KC_MNXT  \
  ),
  [2] = LAYOUT( 
  ...
  [3] = LAYOUT( 
	...
	_______, RGB_SPD, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, _______, _______, _______, _______, _______, _______, _______,          _______,          _______, _______, _______, \
	TG(3),   RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, _______, _______, _______, _______, _______, _______,                   _______,                                     \
	_______, _______, RGB_TOG, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,          _______, _______,                   _______,          \
