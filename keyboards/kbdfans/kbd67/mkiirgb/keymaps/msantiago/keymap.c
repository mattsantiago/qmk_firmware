...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_LAYER0] = LAYOUT_65_ansi_blocker( /* Base */
		    ...
		    KC_LSFT,       KC_Z,     KC_X,     KC_C,  KC_V,  KC_B,  KC_N,    KC_M,  KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT,           KC_UP,     TT(4),  \
		    KC_LCTL,       KC_LGUI,  KC_LALT,                KC_SPC,                KC_RGUI,           FN_APP,   KC_LEFT,           KC_DOWN,   KC_RIGHT),
		[_LAYER1] = LAYOUT_65_ansi_blocker( /* FN */
			KC_ENT,        KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  TG(4),    KC_DEL, \
			KC_LEAD,       KC_INS,   KC_HOME, KC_PGUP, KC_LOCK, KC_WFWD, KC_PIPE, KC_MINS, KC_PLUS, KC_LBRC, KC_RBRC, _______, _______, _______,  KC_HOME,\
		    _______,       KC_DEL,   KC_END,  KC_PGDN, KC_F5,   KC_WBAK, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,  KC_END, \
			_______,       KC_PSCR, KC_SLCK,  KC_PAUS, _______, _______, KC_BSLS, KC_UNDS, KC_EQL,  KC_LCBR, KC_RCBR, _______,          KC_MPLY,  _______,\
		...
		[_LAYER4] = LAYOUT_65_ansi_blocker(
		    ...
		    _______,       KC_BTN1,  KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_HOME,\
			TG(4),         KC_MS_L,  KC_MS_D, KC_MS_R, KC_WH_D, _______, _______, _______, _______, _______, _______, _______,          _______,  KC_END, \
		    _______,       KC_WH_L, KC_BTN3, KC_WH_R,  _______, _______, _______, _______, _______, _______, _______, _______,          KC_VOLU,  TG(4),  \
		    _______,       _______,  _______,                   KC_ESC,                    _______,          _______, KC_MUTE,          KC_VOLD,  _______),
