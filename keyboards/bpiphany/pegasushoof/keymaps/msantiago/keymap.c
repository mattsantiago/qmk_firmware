...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KM_MEDIA] = LAYOUT( \
    ...
    KC_CLCK, KC_INS, KC_HOME,  KC_PGUP, _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP,   KC_MS_RIGHT, _______, _______, _______, _______,    _______, _______, KC_VOLD, \
    _______, KC_DEL, KC_END,   KC_PGDN, KC_F5,   _______, KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,     _______, _______,          _______,                               \
    _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, _______,     _______, _______,          _______,             KC_MPLY,          \
