...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KM_MEDIA] = LAYOUT( \
    ...
    _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______, _______,          _______,             KC_MPLY,          \
    _______, _______, _______,                            KC_ESC,                             _______, _______, KC_APP,  _______,    KC_MPRV, KC_MSTP, KC_MNXT  \
  ),
  /* Layer 2: Mouse keys */
  [KM_MOUSE] = LAYOUT( \
