...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_ENT,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  TG(2),     _______, _______, KC_VOLU, \
        ...
        _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______, _______, _______,                              KC_MPLY, \
        _______, _______, _______,                   KC_ESC,                             _______, TG(3),   KC_APP,  _______,            KC_MPRV, KC_MSTP, KC_MNXT \
    ),
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        KC_ENT,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TG(2),     _______, _______, _______, \
...
/*      _______, RGB_SPD, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, _______, U_T_AUTO,U_T_AGCR,_______, _______, _______, _______, _______,   _______, KC_MUTE, KC_VOLD, \
